...
def wss_get2017(code):
    data=[]
    #按行业
    segment_sales_industry=w.wss(code, "segment_sales", "rptDate=20171231;order=1")
    segment_industry1 = w.wss(code,
          ...
          "rptDate=20171231;order=1;unit=1;currencyType=Cur=CNY")
    segment_industry2 = w.wss(code,
                              "segment_industry_item,segment_industry_sales1,segment_industry_cost1,segment_industry_profit1",
          "rptDate=20171231;order=2;unit=1;currencyType=Cur=CNY")
    segment_industry3 = w.wss(code,
                              "segment_industry_item,segment_industry_sales1,segment_industry_cost1,segment_industry_profit1",
          "rptDate=20171231;order=3;unit=1;currencyType=Cur=CNY")
    segment_industry4 = w.wss(code,
                              "segment_industry_item,segment_industry_sales1,segment_industry_cost1,segment_industry_profit1",
            "rptDate=20171231;order=4;unit=1;currencyType=Cur=CNY")
    segment_industry5 = w.wss(code,
                              "segment_industry_item,segment_industry_sales1,segment_industry_cost1,segment_industry_profit1",
            "rptDate=20171231;order=5;unit=1;currencyType=Cur=CNY")
    #按产品
    segment_sales_product=w.wss(code, "segment_sales","rptDate=20171231;order=2")
    ...
    segment_product5 = w.wss(code,
                             ...
                             "rptDate=20171231;order=5;unit=1;currencyType=Cur=CNY")
    #按地区
    segment_sales_region=w.wss(code, "segment_sales","rptDate=20171231;order=3")
    ...
    segment_region5 = w.wss(code,
                            "segment_region_item,segment_region_sales1,segment_region_cost1,segment_region_profit1",
                            "rptDate=20171231;order=5;unit=1;currencyType=Cur=CNY")
    stmnote_seg=w.wss(code, "stmnote_seg_1501","unit=1;rptDate=20171231")
    #1年以内
    stmnote_ar1=w.wss(code, "stmnote_ar_1,stmnote_ar_2,stmnote_ar_3","unit=1;rptDate=20171231;accYear=1")
    stmnote_ar2 = w.wss(code, "stmnote_ar_1,stmnote_ar_2,stmnote_ar_3", "unit=1;rptDate=20171231;accYear=2")
    stmnote_ar3 = w.wss(code, "stmnote_ar_1,stmnote_ar_2,stmnote_ar_3", "unit=1;rptDate=20171231;accYear=3")
    stmnote_ar4 = w.wss(code, "stmnote_ar_1,stmnote_ar_2,stmnote_ar_3", "unit=1;rptDate=20171231;accYear=4")

    stmnote_ar_cat1=w.wss(code, "stmnote_ar_cat", "unit=1;rptDate=20171231;Category=0")
    stmnote_ar_cat2=w.wss(code, "stmnote_ar_cat", "unit=1;rptDate=20171231;Category=1")
    stmnote_ar_cat3=w.wss(code, "stmnote_ar_cat", "unit=1;rptDate=20171231;Category=2")
    stmnote_ar_cat4=w.wss(code, "stmnote_ar_cat", "unit=1;rptDate=20171231;Category=3")
